...
if [ ! -e $ROOTFS_DIR/.installed ]; then
  wget --tries=$max_retries --timeout=$timeout --no-hsts -O rootfs.tar.gz "https://cdimage.ubuntu.com/ubuntu-base/releases/24.04/release/ubuntu-base-20.04.5-base-${ARCH_ALT}.tar.gz"
